...
ALLOWED_HOSTS = ['4f41-87-117-52-228.ngrok-free.app', '127.0.0.1']
CSRF_TRUSTED_ORIGINS = ["https://4f41-87-117-52-228.ngrok-free.app"]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.common_notifications',
            ],
        },
    },
]
